...
export default function Collect2024({ navigation }) {
  const name = "Emmanuel";
  ...
  const colxxxi = ([{
          ...
          discount:"-10%",
          disprice:"$198",
          image:require('../Collect2024im/Collect2024i.jpg')
      },
      {
          id:"2ciii",
          ...
          discount:"-20%",
          disprice:"$96",
          image:require('../Collect2024im/Collect2024ii.jpg')
      },
      {
          id:"3ciii",
          ...
          discount:"-15%",
          disprice:"$263.5",
          image:require('../Collect2024im/Collect2024iii.jpg')
      },
      {
          id:"4ciii",
          ...
          discount:"-30%",
          disprice:"$91",
          image:require('../Collect2024im/Collect2024iv.jpg')
      },
      {
          id:"5ciii",
          ...
          discount:"-25%",
          disprice:"$105",
          image:require('../Collect2024im/Collect2024v.jpg')
      },
      {
          id:"6ciii",
          ...
          discount:"-20%",
          disprice:"$120",
          image:require('../Collect2024im/Collect2024vi.jpg')
      }
  ])
